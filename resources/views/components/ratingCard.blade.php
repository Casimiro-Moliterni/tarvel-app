...
<div id="ratingCardWrapper-{{ $event->id }}" class="{{ $firstRating ? '' : 'd-none' }}" class="mt-5">
    <section id="star-values" class="position-relative pb-3 ">
        <img class="wave position-absolute w-100" style="height: 250px ; z-index:0 ; bottom:-6rem" src="{{ asset('img/wave-pink.png') }}">
        <h3 class="text-center fs-1 position-relative z-3">La tua recensione</h3>
        <span class="star__container pb-3">
